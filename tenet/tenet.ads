...
package Tenet is
   ...
   -- Root package for a hierarchy of basic container types and basic utility packages.
...
-- $Id: tenet.ads,v 1.3 2004/03/14 21:07:14 debater Exp $
-- $Name:  $
