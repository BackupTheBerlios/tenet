-------------------------------------------------------------------------------------------------------------------
-- =####= Tenet.Reverse_Array procedure body =####=
...
-------------------------------------------------------------------------------------------------------------------
procedure Tenet.Reverse_Array is

   function Swap is new Tenet.Exchange_Pair(Element_Type);
...
begin
   ...
   Set_Current_Locus("Tenet.Reverse_Array"); --$D
