-------------------------------------------------------------------------------------------------------------------
-- =####= Tenet.Exchange_Pair procedure body =####=
...
-------------------------------------------------------------------------------------------------------------------
procedure Tenet.Exchange_Pair (Item_1, Item_2: in out Element_Type) is

   Temp: Element_Type;

begin

   Set_Current_Locus("Tenet.Exchange_Pair"); --$D
...
-- $Id: tenet-exchange_pair.adb,v 1.1 2003/08/11 02:16:57 debater Exp $
-- $Name:  $
...
-- $Source: /home/xubuntu/berlios_backup/github/tmp-cvs/tenet/Repository/tenet/tenet-exchange_pair.adb,v $
-- $RCSfile: tenet-exchange_pair.adb,v $

-- $Log: tenet-exchange_pair.adb,v $
