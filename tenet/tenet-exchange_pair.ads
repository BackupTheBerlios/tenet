-------------------------------------------------------------------------------------------------------------------
-- =####= Tenet.Exchange_Pair generic procedure specification =####=
...
-------------------------------------------------------------------------------------------------------------------
procedure Tenet.Exchange_Pair (Item_1, Item_2: in out Element_Type);
...
-- $Id: tenet-exchange_pair.ads,v 1.2 2004/03/14 21:07:14 debater Exp $
-- $Name:  $
...
-- $Source: /home/xubuntu/berlios_backup/github/tmp-cvs/tenet/Repository/tenet/tenet-exchange_pair.ads,v $
-- $RCSfile: tenet-exchange_pair.ads,v $

-- $Log: tenet-exchange_pair.ads,v $
