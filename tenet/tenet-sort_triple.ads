-------------------------------------------------------------------------------------------------------------------
-- =####= Tenet.Sort_Triple generic procedure specification =####=
...
-------------------------------------------------------------------------------------------------------------------
procedure Tenet.Sort_Triple (Item_1, Item_2, Item_3: in out Element_Type);

   -- Exchanges among three items to ensure Item_2 < Item_1 and Item_3 < Item_2 are both false.
